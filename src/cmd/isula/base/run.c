...
int cmd_run_main(int argc, const char **argv)
{
    ...
    // 所有命令选项数组，使用宏将client_argments对应的数据成员与options的data成员绑定,即data为client_argments的成员的地址
